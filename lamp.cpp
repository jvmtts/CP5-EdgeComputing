...
const char* default_BROKER_MQTT = "68.154.50.209"; // IP do Broker MQTT, Usamos um IP próprio feito no Azure
...
void handleLuminosity() {
    ...
    digitalWrite(D5, LOW);
    tempo = pulseIn(D18, HIGH);
    distancia = tempo/58;
    String mensagem5 = String(distancia);
